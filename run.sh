...
hadoop jar /usr/hdp/2.6.1.0-129/hadoop-mapreduce/hadoop-streaming.jar -input /user/vysakhr/testdata -input /user/vysakhr/joindata -cacheFile /user/vysakhr/counts.txt#ref -output /user/vysakhr/output -file TestNBUsingRequests_mapper.py -mapper TestNBUsingRequests_mapper.py -file TestNBUsingRequests_reducer.py -reducer TestNBUsingRequests_reducer.py
hdfs dfs -cat /user/vysakhr/output/* > output.txt
python ComputePercentage.py